...
from knowledge_bert.modeling import OKELMForSequenceClassification
...
class SemevalProcessor(DataProcessor):
    """Processor for the Twitter data set."""
...
def main():
    ...
    # Prepare model
    model, _ = OKELMForSequenceClassification.from_pretrained(args.ernie_model,
